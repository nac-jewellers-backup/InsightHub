...
$(document).ready(function(){
	...
	if($('#alertFlag').val()=='F'){ toastr.error("Looks like the submitted credentials are incorrect!", "Oops!", { closeButton: !0, tapToDismiss: !1, rtl: o }); }
	if($('#alertFlag').val()=='B'){ toastr.error("Looks like your account is currently blocked by administrator!", "Oops!", { closeButton: !0, tapToDismiss: !1, rtl: o }); }
...
function toggleFullscreen(elem) {
  ...
  $("#clearNotification").click(function(){
	$.ajax({url: "clearNotification.php", success: function(result){
		$("#cntNotification").html('0');
	  }});
  });
